      ...
      components: [
          ...
          parameters: [
            {
              type: "document",
              document: {
                link: "https://undangan.laznasdewandakwah.or.id/wappin_pdf/abc_456.pdf", // Dummy link that we know works (Cloudflare won't block its own static file if it doesn't check it? Wait, let's use a dummy external PDF to be absolutely sure)
        ...
        },
        {
          ...
          parameters: [
            ...
            { type: "text", text: "https://undangan.laznasdewandakwah.or.id/wappin_pdf/abc_456.pdf" },
